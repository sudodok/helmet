...
| **Geo-Tagging Evidence** | ถ่ายภาพผู้กระทำผิด ประทับแถบดำลายน้ำระบุ: **พิกัด Lat/Lon, ความเร็วขณะกระทำผิด, และวันเวลา** บันทึกลงโฟลเดอร์ `captures/` ทันที |
...
├── captures/                   # โฟลเดอร์เก็บภาพถ่ายหลักฐานพร้อมลายน้ำพิกัด GPS (JPG)
