...
```mermaid
flowchart TD
    Start([🟢 เริ่มต้นการทำงานของระบบ]) --> Init[1. โหลดโมเดล YOLOv8n / Haar Cascade<br>2. เริ่มต้นกล้องตรวจจับ Webcam / CSI<br>3. เชื่อมต่อตัวควบคุมวงจร Controller / Relay<br>4. ตั้งค่าโฟลเดอร์ captures/ และตัวแปรระบบ]
    ...
    CheckMidRideCooldown -- ไม่ใช่ / บันทึกแล้ว --> CheckStopStill{ผู้ขับขี่ชะลอรถจนจอดนิ่ง 0 km/h<br>แล้วยังไม่สวมหมวกหรือไม่?}
